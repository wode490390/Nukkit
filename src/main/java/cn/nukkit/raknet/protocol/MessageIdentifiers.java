...
public interface MessageIdentifiers {
    ...
    byte ID_OPEN_CONNECTION_REQUEST_1 = 0x05;
    ...
    byte ID_OPEN_CONNECTION_REPLY_1 = 0x06;
    ...
    byte ID_OUT_OF_BAND_INTERNAL = 0x0d;
    ...
    /// the message arrived
    byte ID_SND_RECEIPT_ACKED = 0x0e;
    ...
    byte ID_INCOMPATIBLE_PROTOCOL_VERSION = 0x19;
    ...
    byte ID_IP_RECENTLY_CONNECTED = 0x1a;
    ...
    byte ID_REPLICA_MANAGER_SCOPE_CHANGE = 0x28;
    /// ReplicaManager plugin - Serialized data of an object
    byte ID_REPLICA_MANAGER_SERIALIZE = 0x29;
    ...
    byte ID_RAKVOICE_OPEN_CHANNEL_REPLY = 0x2d;
    ...
    /// NATPunchthrough plugin: internal
    byte ID_NAT_CONNECT_AT_TIME = 0x3b;
    /// NATPunchthrough plugin: internal
    byte ID_NAT_GET_MOST_RECENT_PORT = 0x3c;
    /// NATPunchthrough plugin: internal
    ...
    byte ID_NAT_TARGET_UNRESPONSIVE = 0x3f;
    ...
    byte ID_NAT_PUNCHTHROUGH_FAILED = 0x42;
    ...
    /// First 4 bytes after the message contains the id
    byte ID_READY_EVENT_UNSET = 0x45;
    /// All systems are in state ID_READY_EVENT_SET
    /// First 4 bytes after the message contains the id
    byte ID_READY_EVENT_ALL_SET = 0x46;
    ...
    byte ID_FCM2_NEW_HOST = 0x52;
    /// \internal For FullyConnectedMesh2 plugin
    byte ID_FCM2_REQUEST_FCMGUID = 0x53;
    /// \internal For FullyConnectedMesh2 plugin
    byte ID_FCM2_RESPOND_CONNECTION_COUNT = 0x54;
    /// \internal For FullyConnectedMesh2 plugin
    byte ID_FCM2_INFORM_FCMGUID = 0x55;
    /// \internal For FullyConnectedMesh2 plugin
    byte ID_FCM2_UPDATE_MIN_TOTAL_CONNECTION_COUNT = 0x56;
    ...
    /// \note Only the designated client gets this message
    byte ID_FCM2_VERIFIED_JOIN_FAILED = 0x59;
    ...
    byte ID_FCM2_VERIFIED_JOIN_ACCEPTED = 0x5a;
    ...
    byte ID_ROUTER_2_FORWARDING_NO_PATH = 0x63;
    ...
    byte ID_ROUTER_2_FORWARDING_ESTABLISHED = 0x64;
    ...
    byte ID_TEAM_BALANCER_REQUESTED_TEAM_FULL = 0x67;
    ...
    byte ID_TEAM_BALANCER_REQUESTED_TEAM_LOCKED = 0x68;
    ...
    byte ID_TWO_WAY_AUTHENTICATION_INCOMING_CHALLENGE_SUCCESS = 0x6d;
    byte ID_TWO_WAY_AUTHENTICATION_OUTGOING_CHALLENGE_SUCCESS = 0x6e;
    ...
    byte ID_TWO_WAY_AUTHENTICATION_INCOMING_CHALLENGE_FAILURE = 0x6f;
    ...
    byte ID_TWO_WAY_AUTHENTICATION_OUTGOING_CHALLENGE_FAILURE = 0x70;
    ...
    byte ID_CLOUD_GET_REQUEST = 0x75;
    byte ID_CLOUD_GET_RESPONSE = 0x76;
    ...
    byte ID_FCM2_UPDATE_USER_CONTEXT = 0x7e;
    byte ID_RESERVED_3 = 0x7f;
    byte ID_RESERVED_4 = 0x80;
    byte ID_RESERVED_5 = 0x81;
    byte ID_RESERVED_6 = 0x82;
