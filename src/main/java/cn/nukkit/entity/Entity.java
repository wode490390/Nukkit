...
public abstract class Entity extends Location implements Metadatable, EntityID {
    ...
    public static final int DATA_CONTAINER_TYPE = 45; //byte (ContainerComponent)
    public static final int DATA_CONTAINER_BASE_SIZE = 46; //int (ContainerComponent)
    public static final int DATA_CONTAINER_EXTRA_SLOTS_PER_STRENGTH = 47; //int (used for llamas, inventory size is baseSize + thisProp * strength)
