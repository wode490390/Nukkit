...
@ToString
public class LevelSoundEventPacket extends DataPacket implements ClientboundPacket, ServerboundPacket {
    ...
    public static final int SOUND_UI_CARTOGRAPHY_TABLE_TAKE_RESULT = 264;
    public static final int SOUND_UI_STONECUTTER_TAKE_RESULT = 265;
    ...
    public static final int SOUND_UNDEFINED = 274;
